"""Tests for Fashion-MNIST recurrence dataset loader."""
...
class TestFMNISTRecurrenceConfig:
...
class TestDefaultConceptGroups:
    def test_all_classes_covered(self):
        """Every Fashion-MNIST class (0-9) appears in exactly one group."""
        all_classes = set()
...
@pytest.mark.slow
class TestGenerateFMNISTRecurrenceDataset:
    def test_smoke(self):
        cfg = FMNISTRecurrenceConfig(
    ...
    def test_concept_specs_populated(self):
        ...
        for spec in ds.concept_specs:
            assert spec.generator_type == "fmnist_recurrence"
    ...
    def test_deterministic(self):
        ...
        ds1 = generate_fmnist_recurrence_dataset(cfg)
        ds2 = generate_fmnist_recurrence_dataset(cfg)
